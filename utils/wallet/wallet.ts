...
import { BASE_BSC_SCAN_URLS, Chain, ChainId } from '../../config/constants/chain'
import { CHAIN_ID } from '../../config/constants/network'
import { nodes } from '../web3/rpc'

const NETWORK_CONFIG = {
  [ChainId[Chain.MAINNET]]: {
    name: 'BNB Smart Chain Mainnet',
    scanURL: BASE_BSC_SCAN_URLS[Chain.MAINNET],
  },
  [ChainId[Chain.TESTNET]]: {
    name: 'BNB Smart Chain Testnet',
    scanURL: BASE_BSC_SCAN_URLS[Chain.TESTNET],
  },
}
